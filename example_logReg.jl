...
objFunc(z,w;konst=nothing) = logisticObjLinear(z,w,y,k=konst)
fPrimeFunc(z,w;konst=nothing) = logisticFPrimeLinear(z,w,y,k=konst)
gradFunc(z,w,X;konst=nothing) = logisticGradLinear(z,w,X,y,k=konst)
